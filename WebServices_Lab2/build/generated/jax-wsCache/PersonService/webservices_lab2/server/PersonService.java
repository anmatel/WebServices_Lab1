 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://Server.webservices_lab2/", wsdlLocation = "http://localhost:1111/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://Server.webservices_lab2/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1111/PersonService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://Server.webservices_lab2/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Server.webservices_lab2/", "PersonWebServicePort"), PersonWebService.class, features);
    }
