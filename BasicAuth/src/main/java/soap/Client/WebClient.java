...
public class WebClient {
    ...
    public final static String LOGIN = "as";
    ...
    public static void main(String[] args) throws MalformedURLException, ParseException, DatatypeConfigurationException, IOException {
        ...
        while (true) {
            ...
            requestContext.put(MessageContext.HTTP_REQUEST_HEADERS, setAuthHeader());
            try {
                switch (actionType) {
                    case "1":
                        getPerson(in);
    ...
    private static Map<String, List<String>> setAuthHeader() {
        Scanner in = new Scanner(System.in);
        Map<String, List<String>> headers = new HashMap();
        
        System.out.println("Enter username: ");
        headers.put("Username", Collections.singletonList(in.nextLine()));
        System.out.println("Enter password: ");
        headers.put("Password", Collections.singletonList(in.nextLine()));
